...
return array(
	'other_setting'     => array(
		...
		'description' => __( 'Configure the following methods after saving changes in this section', 'wc-kmercadopago-gpl' ) . '<ul>
				...
				<li><a href="https://yipi.app/p/mercadopago-para-woocommerce/?utm_source=wordpress_gpl&utm_medium=wordpress_gpl&utm_campaign=wordpress_gpl&utm_id=wordpress_gpl&utm_term=wordpress_gpl&utm_content=wordpress_gpl" target="_blank">' . __( 'Configure Checkout by Tokenize', 'wc-kmercadopago-gpl' ) . '</a> (' . __( 'Only available in MercadoPago Tools Pro', 'wc-kmercadopago-gpl' ) . ')</li>
				<li><a href="https://yipi.app/p/mercadopago-para-woocommerce/?utm_source=wordpress_gpl&utm_medium=wordpress_gpl&utm_campaign=wordpress_gpl&utm_id=wordpress_gpl&utm_term=wordpress_gpl&utm_content=wordpress_gpl" target="_blank">' . __( 'Configure Checkout by QR', 'wc-kmercadopago-gpl' ) . '</a> (' . __( 'Only available in MercadoPago Tools Pro', 'wc-kmercadopago-gpl' ) . ')</li>
			</ul>',
	),
	'enabled'           => array(
