...
- Añadir reembolso automatico del pedido si la cancelas o cambias el estado a reembolsado
...
= v1.0.6 (06/04/2023) =
- Added cancelled order status to refound order
- Added logger of woocommerce for debug and remove file-logger
= v1.0.5 (08/12/2021) =
- Bugfix in header output
= v1.0.4 (01/12/2021) =
